...
describe('Pro License Validation', () => {
  ...
  it('should throw error when no license is provided', () => {
    ...
    expect(() => validateProLicense()).toThrow('PROMPT_CHAINMAIL_PRO_LICENSE environment variable required');
  });

  it('should throw error for invalid JWT format', () => {
    process.env.PROMPT_CHAINMAIL_PRO_LICENSE = 'invalid-jwt';
    expect(() => validateProLicense()).toThrow('License validation failed: Invalid JWT format');
  });
  ...
  it('should throw error for invalid signature', () => {
    ...
    expect(() => validateProLicense()).toThrow('License validation failed: Invalid JWT signature');
  });
  ...
  it('should throw error for wrong tier', () => {
    ...
    expect(() => validateProLicense()).toThrow('License validation failed: Invalid license tier for pro package');
  });
  ...
  it('should throw error for expired license', () => {
    ...
    expect(() => validateProLicense()).toThrow('License validation failed: License has expired');
  });
