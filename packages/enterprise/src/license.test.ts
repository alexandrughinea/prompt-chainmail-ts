...
describe("Enterprise License Validation", () => {
  ...
  it("should throw error when no license is provided", () => {
    ...
    expect(() => validateEnterpriseLicense()).toThrow(
      "PROMPT_CHAINMAIL_ENTERPRISE_LICENSE environment variable required"
    );
  });
  ...
  it("should throw error for invalid signature", () => {
    ...
    const invalidJWT =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJwcm9tcHQtY2hhaW5tYWlsLmNvbSIsInRpZXIiOiJlbnRlcnByaXNlIiwiZXhwIjo5OTk5OTk5OTk5fQ.wrong-signature";
