...
export function validateLicense(
  ...
  try {
    ...
    const tierCapitalized = expectedTier.charAt(0).toUpperCase() + expectedTier.slice(1);
    console.log(`✅ ${tierCapitalized} license validated - expires: ${new Date(payload.exp * 1000).toISOString()}`);
    return true;
